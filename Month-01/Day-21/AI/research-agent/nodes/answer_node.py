"""
Answer Node Module
The final synthesis node of the State Graph. Consolidates accumulated evidence,
mathematical calculations, and literature citations into an authoritative,
...
def answer_node(state: ResearchState) -> Dict[str, Any]:
    ...
    logs.append("[ANSWER NODE] Synthesizing final grounded research report.")

    # Format Key Quantitative Metrics
    key_metrics = {}
    for expr, val in calc_cache.items():
        key_metrics[expr] = val

    # Build Executive Summary & Detailed Analysis
